"""
Django settings for zipper12 project.
...
#
#  heroku config:set DJANGO_SECRET_KEY='-an$l-ap6tx%4@m^h9=7pc^_c!(kgikp40q@!mw7m!9)9k*4af'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = '-an$l-ap6tx%4@m^h9=7pc^_c!(kgikp40q@!mw7m!9)9k*4af'
...
ROOT_URLCONF = 'zipper12.urls'

# WSGI configuration
# See https://docs.djangoproject.com/en/2.0/howto/deployment/wsgi/
WSGI_APPLICATION = 'zipper12.wsgi.application'

# Database
# https://docs.djangoproject.com/en/2.0/ref/settings/#databases
# Parse database configuration from DATABASE_URL using dj-database-url
# if the environment variable is not defined then default to zipper12_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'zipper12_db.sqlite3')),
}
